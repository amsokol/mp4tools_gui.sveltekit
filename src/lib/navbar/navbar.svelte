<script lang="ts">
	...
	import {
		classNavbarMenuTopLevel,
		classNavbarMenuTopLevelIcon,
		classNavbarMenuDropdown,
		styleNavbarMenuDropdown,
		classNavbarMenuDropdownItem,
		classNavbarMenuDropdownItemTitle,
		...
		<div class="flex items-center md:order-2 space-x-2">
			...
			>
				...
				<svg
					...
					><path
						fill-rule="evenodd"
						d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1
						0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z"
						clip-rule="evenodd"
					/></svg
				>
			</button>
			...
			<ul class="flex flex-col mt-4 font-medium md:flex-row md:space-x-9 md:mt-0">
				<li>
					...
					>
						<svg
							...
							stroke-width="1.5"
							stroke="currentColor"
							class={'w-5 h-5' + classNavbarMenuTopLevelIcon}
							aria-hidden="true"
						>
							<path
								stroke-linecap="round"
								stroke-linejoin="round"
								d="M7.5 7.5h-.75A2.25 2.25 0 004.5 9.75v7.5a2.25 2.25 0 002.25 2.25h7.5a2.25 2.25 0 002.25-2.25v-7.5a2.25
								2.25 0 00-2.25-2.25h-.75m-6 3.75l3 3m0 0l3-3m-3 3V1.5m6 9h.75a2.25 2.25 0 012.25 2.25v7.5a2.25 2.25 0
								01-2.25 2.25h-7.5a2.25 2.25 0 01-2.25-2.25v-.75"
							/>
						</svg>
						Mux
						<svg
							...
							><path
								fill-rule="evenodd"
								d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1
								 0 010-1.414z"
								clip-rule="evenodd"
							/></svg
						>
					...
					<div
						...
						class={'grid-cols-1 md:grid-cols-1' + classNavbarMenuDropdown}
						style={styleNavbarMenuDropdown}
						data-popper-reference-hidden=""
						data-popper-escaped=""
						data-popper-placement="bottom"
						role="presentation"
						on:click={() => menuMux.click()}
					>
						<div class={classNavbarMenuDropdownItem}>
							<ul class="space-y-4" aria-labelledby="mux-menu-dropdown-button">
								<li>
									<a href="/" class={classNavbarMenuDropdownItemTitle}>
										<div class="font-semibold">Dolby Vision</div>
										<span class={classNavbarMenuDropdownItemDescription}
				...
				<li>
					...
					>
						...
						>
							<path
								d="M10.304 3.13a1 1 0 0 1 1.196.98v1.8l-2.5.5v5.09c0 .495-.301.883-.662 1.123C7.974 12.866 7.499 13 7
								13c-.5 0-.974-.134-1.338-.377-.36-.24-.662-.628-.662-1.123s.301-.883.662-1.123C6.026 10.134 6.501 10 7
								10c.356 0 .7.068 1 .196V4.41a1 1 0 0 1 .804-.98l1.5-.3z"
							/>
							<path
								d="M4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H4zm0 1h8a1 1 0 0 1 1 1v12a1 1 0 0
								 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"
							/>
						</svg>
						Audio
						<svg
					...
					<div
						...
						class={'grid-cols-2 md:grid-cols-2' + classNavbarMenuDropdown}
						style={styleNavbarMenuDropdown}
						data-popper-reference-hidden=""
						data-popper-escaped=""
						data-popper-placement="bottom"
						role="presentation"
						on:click={() => menuAudio.click()}
					>
						<div class={classNavbarMenuDropdownItem}>
							<ul class="space-y-4" aria-labelledby="audio-menu-dropdown-button">
								<li>
									<a href="/audio/dn" class={classNavbarMenuDropdownItemTitle}>
								...
								<li>
									<a href="/audio/ebur128" class={classNavbarMenuDropdownItemTitle}>
								...
								<li>
									<a href="/audio/delay" class={classNavbarMenuDropdownItemTitle}>
						...
						<div class={classNavbarMenuDropdownItem}>
							<ul class="space-y-4">
								<li>
									<a href="/audio/dts-core" class={classNavbarMenuDropdownItemTitle}>
								...
								<li>
									<a href="/audio/dts2eac3" class={classNavbarMenuDropdownItemTitle}>
				...
				<li>
					<button class={classNavbarMenuTopLevel}>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							fill="currentColor"
							class={'w-4 h-4' + classNavbarMenuTopLevelIcon}
							viewBox="0 0 16 16"
							aria-hidden="true"
						>
							<path
								d="M0 1a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V1zm4 0v6h8V1H4zm8 8H4v6h8V9zM1
								1v2h2V1H1zm2 3H1v2h2V4zM1 7v2h2V7H1zm2 3H1v2h2v-2zm-2 3v2h2v-2H1zM15 1h-2v2h2V1zm-2 3v2h2V4h-2zm2
					...
					<button class={classNavbarMenuTopLevel}>
						...
						>
							<path
								...
								stroke-linejoin="round"
								d="M7.5 7.5h-.75A2.25 2.25 0 004.5 9.75v7.5a2.25 2.25 0 002.25 2.25h7.5a2.25 2.25 0 002.25-2.25v-7.5a2.25
								2.25 0 00-2.25-2.25h-.75m0-3l-3-3m0 0l-3 3m3-3v11.25m6-2.25h.75a2.25 2.25 0 012.25 2.25v7.5a2.25 2.25 0
								01-2.25 2.25h-7.5a2.25 2.25 0 01-2.25-2.25v-.75"
							/>
						</svg>
						Demux
